...
DROP POLICY IF EXISTS "Only admins can view comprehensive analytics" ON public.comprehensive_user_analytics;
...
CREATE POLICY "Authenticated users can view comprehensive analytics" 
