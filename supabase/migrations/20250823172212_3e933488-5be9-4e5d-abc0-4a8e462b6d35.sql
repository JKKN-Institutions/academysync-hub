-- Fix session creation RLS policies and add proper institution-based access control

-- Update the counseling_sessions table to set created_by as NOT NULL with a default
